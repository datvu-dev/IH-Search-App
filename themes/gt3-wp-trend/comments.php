...
<div id="comments">
    ...
    $comment_form = array(
        'fields' => apply_filters( 'comment_form_default_fields', array(
            'author' => '<label class="label-name"></label><input type="text" value="'.__('Name *','theme_localization').'" title="'.__('Name *','theme_localization').'" id="author" name="author" class="form_field">',
            'email'  => '<label class="label-email"></label><input type="text" value="'.__('Email *','theme_localization').'" title="'.__('Email *','theme_localization').'" id="email" name="email" class="form_field">',
            'url'    => '<label class="label-web"></label><input type="text" value="'.__('URL','theme_localization').'" title="'.__('URL','theme_localization').'" id="web" name="url" class="form_field">'
        ) ),
        'comment_field' => '<label class="label-message"></label><textarea name="comment" cols="45" rows="5" title="'.__('Message...','theme_localization').'" id="comment-message" class="form_field">'.__('Message...','theme_localization').'</textarea>',
        'comment_form_before' => '',
        'comment_form_after' => '',
