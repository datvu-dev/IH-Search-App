		...
		$compilepopular .= '
			<li '.((has_post_thumbnail()) ? '' : 'class="no_img"').'>';
                if (has_post_thumbnail()) {
                    $compilepopular .= '<div class="recent_posts_img"><img src="'.aq_resize($featured_image_latest[0], "166", "166", true).'" alt="'.get_the_title().'"></div>';
                }
...
$compilepopular .= '
                <div class="recent_posts_content">
                    ...
                    <!--'.gt3_smarty_modifier_truncate($content_show, ((has_post_thumbnail()) ? 55 : 105)).'-->
					'. get_the_time("F d, Y") .'
					<br>
					'.get_comments_number(get_the_ID()).' '.__('comments','theme_localization').'
                </div>
                <div class="clear"></div>
			</li>
		';
