...
$ezTweet = new ezTweet;
$ezTweet->consumer_key = gt3_get_theme_option('consumer_key');
$ezTweet->consumer_secret = gt3_get_theme_option('consumer_secret');
$ezTweet->user_token = gt3_get_theme_option('user_token');
$ezTweet->user_secret = gt3_get_theme_option('user_secret');
$ezTweet->fetch();
